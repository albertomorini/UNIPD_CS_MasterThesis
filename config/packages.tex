...
\usepackage[table]{xcolor} %--TOPDFA
...
\lstset{
    ...
    keywordstyle=[2]\color{jskeyword}\bfseries,
...
%         import, from, export, default, async, await,
%         function, class, extends, new, this, ref,
%         map, for, foreach, map, filter, accessibilityLabel, accessibilityRole, onPress, style
%     },
%     basicstyle=\ttfamily\footnotesize,
%     sensitive=true,
%     morecomment=[l]{//},
