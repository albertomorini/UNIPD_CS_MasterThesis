...
Over the past few decades, the use of mobile devices has increased drastically, and partially replaces the usage of desktop-based software and web browsers. This shift has been mainly driven by the widespread adoption of smartphones, their increased computational capabilities, but also for the availability of integrated sensors such as GPS, gyroscopes and Bluetooth, which together enable richer and more context-aware user experiences. Consequently, by leveraging these technologies, Online Social Networks have been able to provide more advanced and sophisticated features, collecting larger amounts of more complex metadata thus to increase platform interactions and daily engagement.\\
