...
The server, defining the endpoints decide how to handle request, whenever to demand to a stored procedure or to apply/filters additional control. A interest implementatio regard local collection
% //TODO: but even image storing
