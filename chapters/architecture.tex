...
In specific, a three tier model is composed by the following layers:
...
\begin{itemize}
    ...
    \textit{In GeoMedia, this is represented by the mobile application}
    ...
    \textit{In GeoMedia, this layer is represented by the server-side component that processes client requests and communicates with the data layer through a RESTful interface.}
...
The UML schema in the Figure~\ref{fig:UML-arch} can represent graphically the architecture established.
