...
Despite sharing several functionalities with existing social media platforms, GeoMedia differs from those presented in Chapter~\ref{cap:relatedwork} in several key aspects. \\
A functional comparison of features and capabilities is provided in Table~\ref{tab:comparison}.
...
Multiple creator for a collection/POI
& \checkmark (with restriction for specific users)
& --
& --
& --
& --
