...
The participant's characteristic, specifically the age and IT background and knowledge, are reported in the table~\ref{tab:participants_demographics}.
...
The SUS is a standardized questionnaire originally proposed by researcher John Brooke~\cite{article:brook_sus} to provide a quick and practical measure of the perceived usability of a system. Composed by ten statements evaluate using a five-point Likert scale, ranging from \textit{Strongly disagree} to \textit{Strongly agree}. \\
